...
@XmlRootElement(name = "GetProjectsIssueResponse")
public class GetProjectsIssueResponse {
	...
	public GetProjectsIssueResponse() {}
	
	public GetProjectsIssueResponse(String responseStatusCode, String responseStatusMessage,
